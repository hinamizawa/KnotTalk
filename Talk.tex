...
\begin{frame}
	...
	\begin{align*}
		...
		w(\raisebox{-20pt}{\includegraphics[width=1.8cm]{pic/trifoilrightkaff.png}})                         & =3                                                                                                                                                                                                                     \\
		V(\raisebox{-20pt}{\includegraphics[width=1.8cm]{pic/trifoilrightkaff.png}})                         & = \left(-A^{16}+A^{12}+A^4\right)_{t^{1/2}=A^{-2}} = -t^{-4}+t^{-3}+t^{-1}
	\end{align*}
