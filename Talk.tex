...
\newcommand{\KPUNLINKT}{%
  \KP{\filldraw[color=gray, fill=none, thick] circle (0.3);
  \filldraw[color=gray, fill=none, thick] (0.7,0) circle (0.3);
  \filldraw[color=gray, fill=none, thick] (1.4,0) circle (0.3);}%
}
...
\begin{frame}[t]
	...
	\begin{figure}
		\centering
		\includegraphics[width=7cm]{pic/knowfromstring.png}
		\caption{Knot as a string with two ends spliced together}
	\end{figure}
\end{frame}
...
\begin{frame}[c]
	...
	{\small{\begin{itemize}
				...
				\item $n=$ the sum of crossing numbers of two diagrams; an upper bound on the number of Reidemeister moves is $2^{2^{2^{\dots^n}}}$, where where the height of the tower of $2$s is $10^{1,000,000n}$ (Coward \& Lackenby 2010).
				\item $c=$ numbers of crossing in an unknot diagram; an upper bound on the number of Reidemeister moves required to arrive at the standard unknot is $(236c)^{11}$ (Lackenby 2015).
			\end{itemize}}}
\end{frame}
...
\begin{frame}
	...
	\begin{align*}
		\left\langle\KPUNLINK\right\rangle  & = (-A^{2}-A^{-2})\left\langle\KPA\right\rangle      \\
		                                    & =-A^2-A^{-2};                                       \\
		                                    &                                                     \\
		\left\langle\KPUNLINKT\right\rangle & = (-A^{2}-A^{-2})\left\langle\KPUNLINK\right\rangle \\
		                                    & =(-A^2-A^{-2})^2
	\end{align*}
...
\begin{frame}
	...
	\end{block}
	Indeed, a move of Type I gives an extra $-A^3$ (or $-A^{-3}$) factor.
	% {\small
	% \hspace*{-1cm}
	% \begin{tabular}{ l l }
...
\begin{frame}[c]
	...
	\begin{align*}
		...
		w(\raisebox{-20pt}{\includegraphics[width=1.8cm]{pic/trifoil.png}})                             & =-3                                                                                                                                                                                                          \\
...
\begin{frame}
	...
	\begin{block}{Conjecture}
		The only knot with the Jones polynomial $V(K)=1$ is the unknot.
	\end{block}
...
\begin{frame}
	...
	\begin{figure}
		...
		\caption{The figure-8 knot and its parallels}
	\end{figure}
